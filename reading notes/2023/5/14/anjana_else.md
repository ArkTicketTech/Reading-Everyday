在 GPTs are GPTs: An Early Look at the Labor Market Impact Potential of Large Language Models 这篇论文中，还提到：Generative Pre-trained Transformers(GPTs) are general-purpose technologies(GPTs)。一个狭义，一个广义。
